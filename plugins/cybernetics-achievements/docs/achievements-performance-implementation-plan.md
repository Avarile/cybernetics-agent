# Cybernetics Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.cybernetics/plugins/cybernetics-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.cybernetics/plugins/cybernetics-achievements/scan_checkpoint.json`.
