...
- Snapshot persisted at `~/.hermes/plugins/cybernetics-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hermes/plugins/cybernetics-achievements/scan_checkpoint.json`.
