...
``_check_spotify_available()`` — when the user has not run ``cybernetics auth
spotify``, the tools remain registered (so they appear in ``cybernetics
...
The Spotify auth flow (``cybernetics auth spotify``), CLI plumbing, and docs
