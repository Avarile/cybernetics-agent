---
name: honcho
description: Configure and use Honcho memory with Cybernetics -- cross-session user modeling, multi-profile peer isolation, observation config, dialectic reasoning, session summaries, and context budget enforcement. Use when setting up Honcho, troubleshooting memory, managing profiles with Honcho peers, or tuning observation, recall, and dialectic settings.
version: 2.0.0
...
```bash
cybernetics memory setup honcho
...
See: https://docs.honcho.dev/v3/guides/integrations/cybernetics#running-honcho-locally-with-cybernetics
