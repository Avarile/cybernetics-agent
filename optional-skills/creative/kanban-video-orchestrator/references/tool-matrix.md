...
Maps each role archetype to the Cybernetics skills it should `always_load` and the
toolsets it needs. Only references skills that ship in the public cybernetics-agent
...
## Cybernetics skills relevant to video production

### Visual / rendering skills (`cybernetics-agent/skills/creative/`)
...
### Design / pre-production skills (`cybernetics-agent/skills/creative/`)
...
### Audio / media skills (`cybernetics-agent/skills/creative/` + `skills/media/`)
...
### Kanban infrastructure (`cybernetics-agent/skills/devops/`)
...
These are **not** Cybernetics skills but external CLIs / APIs that profiles invoke.
...
## Built-in Cybernetics tools for media review

These are native Cybernetics tools — not invoked via terminal but through their own
...
| Anthropic | `ANTHROPIC_API_KEY` | every Cybernetics profile (Claude) |
...
When a new Cybernetics-public video skill ships:
