...
- Pollinations text-to-image generation (`pixelart_image.py`,
  `generate_base()` in `pixelart_video.py`) — Cybernetics has `image_generate`
...
- License: MIT (inherits from cybernetics-agent repo)
- Original author of the skill shell: dodo-reach
- Expansion with palettes + video: Cybernetics Agent contributors
