# Agent instructions for Cybernetics WebUI
...
Cybernetics WebUI can read and write real agent state, sessions, workspaces,
...
```bash
HERMES_HOME=/tmp/cybernetics-webui-agent-home \
HERMES_WEBUI_STATE_DIR=/tmp/cybernetics-webui-agent-state \
