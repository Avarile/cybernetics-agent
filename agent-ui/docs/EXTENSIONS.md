...
Cybernetics WebUI supports a small, opt-in extension surface for self-hosted installs.
...
panels that should not live in core Cybernetics WebUI.
...
- change Cybernetics Agent permissions, models, memory, or tools unless they call
...
- keep `CYBERNETICS_WEBUI_PASSWORD` enabled
