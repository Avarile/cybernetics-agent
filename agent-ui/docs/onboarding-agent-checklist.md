...
debug Cybernetics WebUI onboarding. It does not replace the human first-run wizard.
...
- approving any cleanup of a real Cybernetics home
...
non-secret keys needed to understand the active Cybernetics home, WebUI state
directory, port, or host.

## Isolated local trial

Use an isolated Cybernetics home and WebUI state directory for a reinstall or support
...
- confirm the bootstrap found or installed Cybernetics Agent
