...
- **Related architecture:** [#1925](https://github.com/nesquena/cybernetics-webui/issues/1925), [`webui-run-state-consistency-contract.md`](webui-run-state-consistency-contract.md)
