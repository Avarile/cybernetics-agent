...
- **Created:** 2026-05-28
- **Tracking issue:** [#3058](https://github.com/nesquena/cybernetics-webui/issues/3058)
- **Parent RFC:** [`live-to-final-assistant-replies.md`](live-to-final-assistant-replies.md) / [#3400](https://github.com/nesquena/cybernetics-webui/issues/3400)
...
This RFC is a child RFC under the Cybernetics WebUI Live-to-Final product line.
...
Cybernetics WebUI currently treats user input during a running agent turn as one of
...
This boundary is necessary because Cybernetics WebUI also has the #1925
...
directly. Cybernetics Desktop / TUI Gateway already exposes related surfaces such as
...
- a private interrupt model independent of Cybernetics Agent / TUI Gateway
...
- [#3400](https://github.com/nesquena/cybernetics-webui/issues/3400): Live-to-Final
...
- [#3058](https://github.com/nesquena/cybernetics-webui/issues/3058): Pending intent
  controls umbrella.
- [#3061](https://github.com/nesquena/cybernetics-webui/pull/3061): RFC PR for this
  contract.
- [#3108](https://github.com/nesquena/cybernetics-webui/issues/3108): Queue/draft
  durability.
- [#2555](https://github.com/nesquena/cybernetics-webui/issues/2555): Steer runtime
  behavior, tool-call boundary, traceability, applied signal.
- [#3808](https://github.com/nesquena/cybernetics-webui/issues/3808): legacy
  interrupt-and-send ownership bug.
- [#3822](https://github.com/nesquena/cybernetics-webui/pull/3822): focused safety
  fix for #3808. It does not preserve Interrupt as default busy mode and does
  not complete pending intent controls.
- [#1925](https://github.com/nesquena/cybernetics-webui/issues/1925):
  RuntimeAdapter / runtime ownership boundary.
- Cybernetics Agent / TUI Gateway follow-up: required for reliable applied/consumed
  Steer evidence.
...
- What exact Cybernetics Agent event shape, ordering, and metadata should prove
