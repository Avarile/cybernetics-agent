...
def build_report(root: Path) -> dict[str, object]:
    ...
    classes = (
        ...
        DependencyClass(
            ...
            current_dependency=(
                "Browser chat, approvals, tools, and scheduled work import Cybernetics Agent "
            ...
            replacement_surface=(
                ...
                "Cybernetics Agent APIs or a versioned client package before removing source mounts."
            ),
            findings=_findings_by_kind(
                runtime_findings,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="Path to the cybernetics-webui checkout; defaults to this script's repo.",
    )
    parser.add_argument(
        "--format",
