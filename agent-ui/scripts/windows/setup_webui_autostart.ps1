...
$description = "Auto-start Cybernetics WebUI inside WSL at Windows logon. Runs $WslScriptPath."
...
if ($PSCmdlet.ShouldProcess($TaskName, "Register Windows Scheduled Task for Cybernetics WebUI WSL autostart")) {
