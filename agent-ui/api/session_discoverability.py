"""Read-only sidebar discoverability audit for Cybernetics WebUI sessions.
...
def _main() -> int:
    parser = argparse.ArgumentParser(description="Read-only Cybernetics WebUI session discoverability audit")
