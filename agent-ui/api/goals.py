"""WebUI bridge for Cybernetics persistent session goals."""
...
def _default_max_turns() -> int:
    """Return the configured /goal turn budget, defaulting to Cybernetics' 20 turns."""
    try:
...
class _ProfileGoalManager:
    ...
    def __init__(self, session_id: str, *, profile_home: str | Path, default_max_turns: int = 20):
        if GoalState is None:
            raise RuntimeError("Cybernetics goal state unavailable")
