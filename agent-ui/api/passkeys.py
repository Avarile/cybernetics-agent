"""Passkey/WebAuthn helpers for Cybernetics WebUI.
...
def registration_options(handler) -> dict[str, Any]:
    ...
    return {
        ...
        "user": {"id": _b64u(hashlib.sha256(rp_id.encode()).digest()[:16]), "name": "Cybernetics WebUI", "displayName": "Cybernetics WebUI"},
