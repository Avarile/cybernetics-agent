...
def _main() -> int:
    parser = argparse.ArgumentParser(description="Audit Cybernetics WebUI session recovery state")
    ...
    parser.add_argument("--state-db", type=Path, default=None, help="optional Cybernetics state.db path")
