# Cybernetics WebUI — Themes

Cybernetics WebUI splits **appearance** into two independent pickers:
...
| Skin | Description |
|------|-------------|
| **Default** | The original Cybernetics gold accent. Warm and understated. |
