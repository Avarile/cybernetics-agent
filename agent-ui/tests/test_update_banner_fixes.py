...
class TestUpdateChecker:
    def test_build_compare_url_requires_all_pieces(self):
        ...
        assert upd._build_compare_url(
            'https://github.com/nesquena/cybernetics-webui', 'abc1234', 'def5678'
        ) == 'https://github.com/nesquena/cybernetics-webui/compare/abc1234...def5678'
        assert upd._build_compare_url(None, 'abc1234', 'def5678') is None
        assert upd._build_compare_url('https://github.com/nesquena/cybernetics-webui', None, 'def5678') is None
        assert upd._build_compare_url('https://github.com/nesquena/cybernetics-webui', 'abc1234', None) is None
    ...
    def test_build_compare_url_rejects_unsafe_remote_urls(self):
        ...
        assert upd._build_compare_url('file:///tmp/cybernetics-webui', 'abc1234', 'def5678') is None
        assert upd._build_compare_url('https:github.com/nesquena/cybernetics-webui', 'abc1234', 'def5678') is None
        assert upd._build_compare_url('https://github.com/nesquena/cybernetics-webui', 'abc1234', 'def5678')
    ...
    def test_check_repo_omits_compare_url_when_merge_base_missing(self, tmp_path, monkeypatch):
        ...
        def fake_run(args, cwd, timeout=10):
            ...
            if args[:3] == ['rev-parse', '--short', 'origin/master']:
                return 'def5678', True
            if args[:2] == ['remote', 'get-url']:
                return 'https://github.com/nesquena/cybernetics-webui.git', True
            return '', True
    ...
    def test_repo_url_strips_only_dot_git_suffix(self, tmp_path, monkeypatch):
        ...
        assert result['repo_url'] == 'https://github.com/nesquena/cybernetics-webui'
...
class TestUpdateCompareSource:
    def test_simulated_update_check_payload_includes_both_safe_compare_urls(self):
        src = read('api/routes.py')
        assert '"repo_url": "https://github.com/nesquena/cybernetics-webui"' in src
        assert '"compare_url": "https://github.com/nesquena/cybernetics-webui/compare/abc1234...def5678"' in src
