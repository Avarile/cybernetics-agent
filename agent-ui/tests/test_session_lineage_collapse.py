...
const sessions = [
  {{session_id:'root', title:'Cybernetics WebUI', message_count:10, updated_at:10, last_message_at:10, _lineage_root_id:'root', _lineage_tip_id:'root'}},
  {{session_id:'tip', title:'Cybernetics WebUI', message_count:20, updated_at:20, last_message_at:20, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
...
const sessions = [
  {{session_id:'root', title:'Cybernetics WebUI', message_count:10, updated_at:10, last_message_at:10, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
  {{session_id:'tip', title:'Cybernetics WebUI', message_count:20, updated_at:20, last_message_at:20, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
];
const collapsed = _collapseSessionLineageForSidebar(sessions);
...
const parentRow={{
  session_id:'tip',
  title:'Cybernetics WebUI #8',
  _lineage_root_id:'root',
  _lineage_segments:[
    {{session_id:'tip', title:'Cybernetics WebUI #8', display_title:'Cybernetics WebUI #177'}},
    {{session_id:'old-parent', title:'Cybernetics WebUI #8', display_title:'Cybernetics WebUI #176'}},
  ],
}};
const child={{
  session_id:'child',
...
"""
    ...
    assert child["_parent_segment_title"] == "Cybernetics WebUI #176"


def test_default_webui_numbered_titles_are_not_treated_as_hash_tags():
    """The reconciled title 'Cybernetics WebUI #177' must render with its number intact."""
    js = SESSIONS_JS_PATH.read_text(encoding="utf-8")
    source = f"""
const src = {js!r};
function extractFunc(name) {{
...
console.log(JSON.stringify({{
  webui:_sessionTitleTags('Cybernetics WebUI #177'),
