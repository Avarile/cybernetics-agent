...
class TestDeleteProject:
    ...
    async def test_delete_no_auth_refuses_unassign(self):
        """Without CYBERNETICS_WEBUI_PASSWORD, delete_project must NOT touch
        ...
        os.environ.pop("CYBERNETICS_WEBUI_PASSWORD", None)
        ...
        assert "CYBERNETICS_WEBUI_PASSWORD" in result["warning"]
