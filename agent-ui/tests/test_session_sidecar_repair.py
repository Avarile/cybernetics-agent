...
class TestNonEmptyMessagesPendingCleared:
    ...
    def test_journaled_partial_output_is_recovered_before_interrupted_marker(self, hermes_home, monkeypatch):
        ...
        append_run_event(
            ...
            {
                "name": "terminal",
                "preview": "gh pr list --repo nesquena/cybernetics-webui",
                "args": {"command": "gh pr list --repo nesquena/cybernetics-webui"},
            },
        )
        append_run_event(
            s.session_id,
        ...
        core_tool_calls = [
            {
                "name": "terminal",
                "preview": "gh pr list --repo nesquena/cybernetics-webui",
                "snippet": "gh pr list --repo nesquena/cybernetics-webui",
                "assistant_msg_idx": 1,
                "done": True,
            },
        ]
