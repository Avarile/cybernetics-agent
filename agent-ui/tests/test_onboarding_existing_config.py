"""Tests for fix: onboarding wizard must not fire when Cybernetics is already configured.

Issue #420 — existing Cybernetics users (config.yaml present + chat_ready) were
...
class TestOnboardingGate:
    def test_config_exists_and_chat_ready_returns_completed_true(self, tmp_path):
        ...
        assert result["completed"] is True, (
            "Wizard fired for existing Cybernetics user! "
