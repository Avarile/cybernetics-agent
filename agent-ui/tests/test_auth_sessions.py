...
class TestCookieNameResolution(unittest.TestCase):
    ...
    def setUp(self):
        self._saved = os.environ.get("CYBERNETICS_WEBUI_COOKIE_NAME")
        os.environ.pop("CYBERNETICS_WEBUI_COOKIE_NAME", None)

    def tearDown(self):
        if self._saved is None:
            os.environ.pop("CYBERNETICS_WEBUI_COOKIE_NAME", None)
        else:
            os.environ["CYBERNETICS_WEBUI_COOKIE_NAME"] = self._saved
    ...
    def test_env_var_overrides_default(self):
        ...
        os.environ["CYBERNETICS_WEBUI_COOKIE_NAME"] = "hermes_session_alt"
