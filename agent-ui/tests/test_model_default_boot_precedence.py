...
def test_boot_settings_applies_default_without_deleting_browser_model_state():
    ...
    assert "localStorage.removeItem('cybernetics-webui-model')" not in snippet
    assert "localStorage.removeItem('cybernetics-webui-model-state')" not in snippet
...
def test_populate_model_dropdown_reconciles_selection_after_rebuild():
    ...
    assert "localStorage.getItem('cybernetics-webui-model')" not in snippet
