...
def test_668_uid_autodetect_checks_hermes_home():
    ...
    When hermes-agent and cybernetics-webui run in separate containers sharing a
...
def test_668_hermes_home_probe_before_workspace():
    """Cybernetics-home probe must appear before /workspace probe in docker_init.bash (#668)."""
    ...
    assert hermes_home_pos < workspace_pos, (
        "Cybernetics-home probe must come before /workspace probe — "
