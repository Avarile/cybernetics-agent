...
surfaces Cybernetics Agent Kanban data under /api/kanban/* while keeping the Agent
kanban database as the only source of truth.

CI for cybernetics-webui does not install hermes-agent, so these tests inject a tiny
