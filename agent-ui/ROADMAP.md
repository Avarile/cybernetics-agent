# Cybernetics WebUI — Roadmap

> Web companion to the Cybernetics Agent CLI. Same workflows, browser-native.
>
...
| Surface | Status |
|---|---|
| **Cybernetics CLI parity** | ✅ Complete — every CLI workflow has a web equivalent |
...
- [x] Cybernetics Control Center modal (centralized actions)
...
- [x] Native macOS app — universal Intel + Apple Silicon, signed + notarized DMG, Sparkle 2 auto-update — see `cybernetics-webui/hermes-swift-mac` repo
...
| Cybernetics Agent dashboard cross-link | #1459 | Detect a running Cybernetics Agent and surface link in nav |
...
- **Native MCP server expose** — Cybernetics WebUI as an MCP server for direct agent integration (#733)
- **Teams / agents management panel** — editable names, roles, assignments (#719)
- **Web UI profile model alignment with Cybernetics runtime** — design parity (#749)
...
- Plugin marketplace — Cybernetics skills cover this surface
