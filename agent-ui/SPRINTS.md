# Cybernetics WebUI — Sprint Planning
...
- **Sprint 25** — macOS desktop application. Native Swift + WKWebView shell, universal Intel + Apple Silicon DMG, Sparkle 2 auto-update. Lives in the separate `cybernetics-webui/hermes-swift-mac` repo.
...
- **Plugin marketplace** — Cybernetics skills already cover this surface.
