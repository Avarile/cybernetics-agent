<#
.SYNOPSIS
    Native Windows launcher for Cybernetics WebUI - PowerShell equivalent
...
.LINK
    https://github.com/nesquena/cybernetics-webui/issues/1952
#>
...
# === Find Cybernetics Agent dir (server.py imports from it) =================
...
# PR #2783: nesquena/cybernetics-webui requested this guard.
...
Write-Host "[start.ps1] Cybernetics WebUI native Windows launcher" -ForegroundColor Cyan
...
if (-not (Test-Path $serverPath)) {
    Write-Error "server.py not found at $serverPath - is this the cybernetics-webui repo root?"
    exit 1
}
