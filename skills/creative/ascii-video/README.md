...
Built for [Cybernetics Agent](https://github.com/NousResearch/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/cybernetics-agent/skills/creative/ascii-video`](https://github.com/NousResearch/cybernetics-agent/tree/main/skills/creative/ascii-video) via PR.
