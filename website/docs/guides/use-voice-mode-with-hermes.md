---
sidebar_position: 8
title: "Use Voice Mode with Cybernetics"
description: "A practical guide to setting up and using Cybernetics voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Cybernetics
...
- you want Cybernetics sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Cybernetics.
...
## Step 1: make sure normal Cybernetics works first
...
Cybernetics supports both local and cloud speech stacks.
...
4. Cybernetics transcribes and responds
...
- asking Cybernetics to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Cybernetics loop.

## Tuning CLI behavior

### Silence threshold

If Cybernetics starts/stops too aggressively, tune:
...
Cybernetics stays a normal chat bot, but can speak replies.
...
- you want Cybernetics to function like a portable research or ops assistant
...
Cybernetics joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Cybernetics detects speech boundaries
- transcripts are posted in the associated text channel
- Cybernetics responds in text and audio
...
1. get text Cybernetics working
2. install `cybernetics-agent[voice]`
