...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/productivity/siyuan` |
...
```yaml
# In ~/.cybernetics/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
