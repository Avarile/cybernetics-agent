...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Cybernetics Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.cybernetics/.env`:
