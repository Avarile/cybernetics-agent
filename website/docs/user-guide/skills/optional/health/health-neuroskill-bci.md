...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/health/neuroskill-bci` |
...
Connect Cybernetics to a running [NeuroSkill](https://neuroskill.com/) instance to read
