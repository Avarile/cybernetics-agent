...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Cybernetics Agent |
| License | MIT |
...
Helper script path: `~/.cybernetics/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.cybernetics/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.cybernetics/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.cybernetics/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
