...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Cybernetics Agent |
| License | MIT |
...
The script reads `~/.cybernetics/.env` for two optional defaults:
...
Helper script: `~/.cybernetics/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.cybernetics/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.cybernetics/.env`.
...
```bash
python3 ~/.cybernetics/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.cybernetics/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
