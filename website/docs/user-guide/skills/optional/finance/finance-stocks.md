...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Cybernetics Agent |
| License | MIT |
...
```
SCRIPT=~/.cybernetics/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cybernetics/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
