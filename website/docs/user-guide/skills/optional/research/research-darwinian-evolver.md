...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Cybernetics Agent |
| License | MIT |
...
import upstream classes into Cybernetics itself.
...
```bash
mkdir -p ~/.cybernetics/cache/darwinian-evolver && cd ~/.cybernetics/cache/darwinian-evolver
...
```bash
cd ~/.cybernetics/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.cybernetics/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.cybernetics/skills/research/darwinian-evolver
DE_DIR=~/.cybernetics/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Cybernetics core.
   Custom driver scripts under `~/.cybernetics/skills/...` are user-side and fine.
