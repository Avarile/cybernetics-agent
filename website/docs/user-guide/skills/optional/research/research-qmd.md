...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/research/qmd` |
...
Cybernetics Agent via the native MCP client. This is the preferred
...
Then configure Cybernetics Agent to connect via HTTP:
