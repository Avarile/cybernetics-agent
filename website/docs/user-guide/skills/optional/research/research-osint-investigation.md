...
| | |
|---|---|
| Source | Optional — install with `cybernetics skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Cybernetics Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $HERMES_OSINT_CACHE/icij/ (default: ~/.cache/cybernetics-osint/icij/).
