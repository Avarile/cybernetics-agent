...
- User wants **Cybernetics itself to drive a browser** → use Cybernetics' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
