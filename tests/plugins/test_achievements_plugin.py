"""Tests for the bundled cybernetics-achievements dashboard plugin.
...
``plugins/cybernetics-achievements/tests/`` covering the achievement engine
internals (tier math, secret-state handling, catalog invariants). These
tests live at the cybernetics-agent level and focus on the integration
