"""Lightweight internationalization (i18n) for Cybernetics static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Cybernetics itself -- approval prompts, a handful of gateway slash
