"""Coding-context awareness — base Cybernetics, every interactive surface.

When the user runs Cybernetics inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Cybernetics shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Cybernetics should operate in its coding posture right now."""
