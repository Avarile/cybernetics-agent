...
Storage
-------
Bundles live in ``~/.cybernetics/skill-bundles/*.yaml`` (and the equivalent
...
- :func:`list_bundles` — return rich info for display (``cybernetics bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `cybernetics bundles` CLI subcommand.
# ---------------------------------------------------------------------------
