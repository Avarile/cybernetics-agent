...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Cybernetics also honours HERMES_CA_BUNDLE (its own convention)
...
# Minimum context length required to run Cybernetics Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Cybernetics from probing-down to
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Cybernetics grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Cybernetics sends to providers:
