...
/** Legacy Nous DS font helpers — no-op under the shadcn light theme.
 *  Kept exported so all call sites keep compiling while we sweep them. */
export const themedFont = "";
export const themedBody = "";
export const themedChrome = "";
