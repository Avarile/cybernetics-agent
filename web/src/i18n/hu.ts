...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.cybernetics/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.cybernetics/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.cybernetics/skills/ mappából töltődnek be",
