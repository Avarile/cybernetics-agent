...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bu eklenti ~/.cybernetics/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.cybernetics/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.cybernetics/skills/ adresinden yüklenir",
