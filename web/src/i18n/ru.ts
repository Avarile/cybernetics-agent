...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Удалить этот плагин из ~/.cybernetics/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.cybernetics/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.cybernetics/skills/",
