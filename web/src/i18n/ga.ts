...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bain an plugin seo ó ~/.cybernetics/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.cybernetics/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.cybernetics/skills/",
