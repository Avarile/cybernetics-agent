...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.cybernetics/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.cybernetics/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.cybernetics/skills/",
