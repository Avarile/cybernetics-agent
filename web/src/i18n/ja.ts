...
export const ja: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "このプラグインを ~/.cybernetics/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.cybernetics/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.cybernetics/skills/ から読み込まれます",
