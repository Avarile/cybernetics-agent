...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.cybernetics/plugins/?",
    removeHint: "Only user-installed plugins under ~/.cybernetics/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.cybernetics/skills/",
