...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Cybernetics Teal",
  description: "Classic dark teal — the canonical Cybernetics look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Cybernetics Teal (Large)",
  description: "Cybernetics Teal with bigger fonts and roomier spacing",
