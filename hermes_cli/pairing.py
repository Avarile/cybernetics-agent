...
Usage:
    cybernetics pairing list              # Show all pending + approved users
    cybernetics pairing approve <platform> <code>  # Approve a pairing code
    cybernetics pairing revoke <platform> <user_id> # Revoke user access
    cybernetics pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cybernetics pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cybernetics pairing {list|approve|revoke|clear-pending}")
        print("Run 'cybernetics pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.cybernetics/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'cybernetics pairing list' to see pending codes.\n")
