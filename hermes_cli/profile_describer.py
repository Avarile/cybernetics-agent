...
Used by ``cybernetics profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Cybernetics Agent kanban board.
...
Rules:
  ...
  - Never write "Cybernetics Agent profile" or other meta-narration.
