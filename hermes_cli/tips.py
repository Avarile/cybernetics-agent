...
TIPS = [
    ...
    "cybernetics mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "cybernetics backup creates a zip backup of your entire Hermes home directory.",
    ...
    "cybernetics gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "cybernetics acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'cybernetics dashboard embeds the full Hermes TUI in your browser via xterm.js and a WebSocket PTY.',
