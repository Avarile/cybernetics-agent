...
Entry point: ``cybernetics whatsapp-cloud`` (dispatched from
...
Cybernetics gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Cybernetics to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Cybernetics needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Cybernetics gateway in another terminal:")
    print("         cybernetics gateway")
    print()
