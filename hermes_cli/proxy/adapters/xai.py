...
# xAI's public API is OpenAI-compatible for the endpoints Cybernetics commonly
# uses. The Responses endpoint is included because Cybernetics' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Cybernetics-managed OAuth credentials."""
