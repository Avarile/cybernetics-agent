...
def check_for_updates() -> Optional[int]:
    """Check whether a Cybernetics update is available.
    ...
    # and `cybernetics update` correctly refuses to run in-place inside the
...
def _resolve_repo_dir() -> Optional[Path]:
    """Return the active Cybernetics git checkout, or None if this isn't a git install.
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    Cybernetics checkout. Cached per-process. Release URL always points at the
