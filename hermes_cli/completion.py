...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# Cybernetics Agent bash completion
# Add to ~/.bashrc:
...
# Cybernetics Agent zsh completion
# Add to ~/.zshrc:
...
{top_cmds_str}
            ...
            _describe 'cybernetics command' subcmds
            ;;
        args)
            case ${{line[1]}} in
{sub_cases_str}
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# Cybernetics Agent fish completion",
        "# Add to your config:",
        "#   cybernetics completion fish | source",
        "",
        ...
        "complete -c cybernetics -f",
        "",
        "# Complete profile names after -p / --profile",
        "complete -c cybernetics -f -s p -l profile"
